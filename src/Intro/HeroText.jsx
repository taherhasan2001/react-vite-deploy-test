  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex flex-col text-8vw md:text-40px font-bold mb-24px pt-100px text-white"
      >
      ...
      <motion.span
        ...
        className="mb-30px w-3/4 lg:w-1/3 md:w-1/2 text-25px leading-tight text-white"
      >
